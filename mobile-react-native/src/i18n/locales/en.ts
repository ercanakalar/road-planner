...
const en = {
  ...
  settings: {
    ...
    automaticFollowsPhone: "Automatic follows your phone's light or dark setting.",
    themeLight: 'Light',
    themeDark: 'Dark',
    ...
    inAppMessagesHint: 'Show toast messages for route and favourite changes.',
  ...
  auth: {
    ...
    createAccountSubtitle: 'Plan routes and save the places you care about.',
  ...
  searchScreen: {
    ...
    searchRoutesHint: 'Search published routes, or browse the newest below.',
  ...
  toast: {
    ...
    changesNotAppliedRetry: 'Your changes were not applied. Please try again.',
    ...
    signInAlreadyOpen: 'Another sign-in is already open. Finish or close it first.',
    ...
    photoUploadFailed: 'Your photo could not be uploaded. Please try again.',
  ...
  dialogs: {
    ...
    removeFavouriteMessage: '“{{title}}” will be removed from your favourites.',
    removeRouteMessage:
  ...
  forms: {
    ...
    passwordNeedsLetterAndNumber: 'Include at least one letter and one number.',
    ...
    couldNotChangePassword: 'Could not change your password. Please try again.',
  ...
  errors: {
    ...
    googleSlow: 'Google took too long to answer. Check the connection and try again.',
    googleStillStarting: 'Google sign-in is still starting up. Try again in a moment.',
